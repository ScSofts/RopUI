#ifndef _ROP_PLATFORM_LINUX_POLL_WORKER_TIMER_H
#define _ROP_PLATFORM_LINUX_POLL_WORKER_TIMER_H
...
// A worker watcher backed by timerfd + poll; allows setting an arbitrary itimerspec.
...
#endif // _ROP_PLATFORM_LINUX_POLL_WORKER_TIMER_H
